...
import {setBooking, getAllBooking, getBookingDetail, getAllBookingAdmin, updateBookingAdmin, updateBooking} from '../controllers/bookingController.js';
...
bookingRouter.patch('/admin/booking/:bookingId', autenticate, updateBookingAdmin); //admin
