...
import { getAllPaymentAdmin, getPaymentDetailAdmin, setBankPayment, setWisePayment, updateBankWiseMethodPayment } from '../controllers/paymentController.js';
...
paymentRouter.get('/admin/payment/:paymentId', autenticate, getPaymentDetailAdmin); //admin
